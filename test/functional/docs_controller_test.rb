...
class DocsControllerTest < ActionController::TestCase
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post :create, doc: { : @doc., adventure_id: @doc.adventure_id, gdoclink: @doc.gdoclink, history: @doc.history, name: @doc.name, user_id: @doc.user_id }
    end
  ...
  test "should update doc" do
    put :update, id: @doc, doc: { : @doc., adventure_id: @doc.adventure_id, gdoclink: @doc.gdoclink, history: @doc.history, name: @doc.name, user_id: @doc.user_id }
    assert_redirected_to doc_path(assigns(:doc))
  end
