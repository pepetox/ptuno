...
class AdventuresControllerTest < ActionController::TestCase
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post :create, adventure: { description: @adventure.description, mc: @adventure.mc, name: @adventure.name, playing: @adventure.playing, system: @adventure.system }
    end
  ...
  test "should update adventure" do
    put :update, id: @adventure, adventure: { description: @adventure.description, mc: @adventure.mc, name: @adventure.name, playing: @adventure.playing, system: @adventure.system }
    assert_redirected_to adventure_path(assigns(:adventure))
  end
